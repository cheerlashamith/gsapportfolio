...
class App {
  ...
  onWheel(e: WheelEvent) {
    ...
    this.scroll.target += delta * 0.015 * this.scrollSpeed;
  ...
  onCheck() {
    ...
    if (this.onActiveIndexChange) {
      const realIndex = itemIndex % this.medias.length;
  ...
  addEventListeners() {
    ...
    this.container.addEventListener("mousewheel", this.boundOnWheel as any, { passive: false });
    this.container.addEventListener("wheel", this.boundOnWheel as any, { passive: false });
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "text-foreground font-bold text-[18px]",
        fontClassName,
        className,
      )}
      style={{
